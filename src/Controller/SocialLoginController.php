...
class SocialLoginController extends ControllerBase {
  ...
  public function callbackHandler() {
    ...
    if (isset($_POST) && !empty($_POST['connection_token']) && !empty($_POST['oa_action']) && in_array($_POST['oa_action'], [
        'social_login',
        'social_link',
      ])) {
      // Add system log.
      ...
      $registration_method = (in_array($registration_method, [
        'manual',
        'auto_random_email',
        'auto_manual_email',
      ...
      $registration_approval = (in_array($registration_approval, [
        'inherit',
        'disable',
        'enable',
